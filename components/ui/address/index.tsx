...
function AddressAutoCompleteInput(props: CommonProps) {
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between rounded-lg border bg-background ring-offset-background text-sm ">
        <CommandPrimitive.Input
          ...
          className="w-full p-3 rounded-lg outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]"
        />
      </div>
                    ...
                    {predictions.map(
                      (prediction: {
                        ...
                        <CommandPrimitive.Item
                          ...
                          className="flex select-text flex-col cursor-pointer gap-0.5 h-max p-2 px-3 rounded-md aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground items-start text-sm"
